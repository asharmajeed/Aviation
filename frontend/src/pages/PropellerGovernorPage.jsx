...
const PropellerGovernorPage = () => {
  const [propellerGovernorList, setPropellerGovernorList] = useState([]);
  ...
  const handleSubmit = async (e) => {
    ...
    const repairData = {
      ...
      componentType: "Propeller Governor",
    };
    ...
    try {
      ...
      setPropellerGovernorList([...propellerGovernorList, newRepair]);
  ...
  useEffect(() => {
    fetchRepairs("Propeller Governor");
  }, []);

  useEffect(() => {
    if (propellerGovernorList.length > 0) {
      setFetchExpireDate(
        propellerGovernorList[propellerGovernorList.length - 1].expireDate
      ); // Set expireDate from the first repair
    }
  }, [propellerGovernorList]);
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-4">Propeller Governor Monitoring</h1>
      <p className="text-gray-700 mb-4">
        Monitor the life and maintenance status of the Propeller Governor system.
      </p>
      ...
      {propellerGovernorList.length > 0 ? (
      ...
      {isFormVisible && (
        ...
        >
          <h3 className="text-lg font-bold mb-4">
            Add Propeller Governor Repair Info
          </h3>
          <form onSubmit={handleSubmit}>
            ...
            >
              Add to Propeller Governor List
            </button>
          </form>
        </div>
      )}
...
export default PropellerGovernorPage;
