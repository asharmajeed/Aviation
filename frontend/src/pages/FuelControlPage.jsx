...
const FuelControlPage = () => {
  ...
  useEffect(() => {
    if (fuelControlList.length > 0) {
      setFetchExpireDate(
        fuelControlList[fuelControlList.length - 1].expireDate
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-4">Fuel Control Monitoring</h1>
      <p className="text-gray-700 mb-4">
        Monitor the life and maintenance status of the Fuel Control system.
      </p>
